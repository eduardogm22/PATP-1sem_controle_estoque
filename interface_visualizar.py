...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.setColumnWidth(1,530)
        self.treeWidget.headerItem().setText(2, _translate("MainWindow", "Quantidade"))
        self.treeWidget.headerItem().setText(3, _translate("MainWindow", "Medida"))
        self.treeWidget.setColumnWidth(3,70)
        self.treeWidget.headerItem().setText(4, _translate("MainWindow", "Fornecedor"))
        self.treeWidget.setColumnWidth(4,180)
        self.treeWidget.headerItem().setText(5, _translate("MainWindow", "Fabricação"))
        self.treeWidget.headerItem().setText(6, _translate("MainWindow", "Validade"))
